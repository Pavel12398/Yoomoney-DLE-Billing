...
/**
 * plugin yoomoney for DLE Billing
 *
 * @link          https://github.com/Pavel12398/Yoomoney-DLE-Billing
 * @author        Pavel12398 <dev.necropan@gmail.com>
 */

Class Payment
{
	var $doc = 'https://yoomoney.ru/docs/payment-buttons';
	...
	function Settings( $config )
	{
		...
		$Form[] = array(
			...
			"<input name=\"save_con[yanumber]\" class=\"edit bk\" type=\"text\" value=\"" . $config['yanumber'] ."\" style=\"width: 100%\">"
		);

		$Form[] = array(
			"Секретное слово:",
			"Секретное слово позволит вам проверять подлинность уведомлений.",
	...
	function Form( $id, $payment_config, $invoice, $currency, $desc )
	{
		...
		return '<form method="POST" id="paysys_form" action="https://yoomoney.ru/quickpay/confirm.xml">
				 ...
				 <br />
				 <input type="submit" name="submit-button" class="btn btn-dark" value="Оплатить">
				</form>';
	}
